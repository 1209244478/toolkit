...
export const TOOLS: Tool[] = [
  ...
  { icon: '👤', name: '头像生成器', desc: '在线生成自定义风格头像，支持多种样式', cat: 'image', badge: 'hot', slug: 'avatar-generator', externalUrl: 'https://avatar.nishang2.top/' },
  { icon: '🧰', name: '工具大全', desc: '收录1000+在线工具，包含图片处理、PDF转换、文字识别等', cat: 'fun', badge: 'hot', slug: 'tool-collection', externalUrl: 'https://tools.nishang2.top/' },
